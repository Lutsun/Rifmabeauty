            ...
            {itemCount === 0 ? (
              ...
              <div className="space-y-6">
                {items.map((item) => {
                  ...
                  return (
                    <div key={item.id} className="flex space-x-4 group border-b border-gray-100 pb-4">
                      <div className="w-24 h-24 bg-stone-100 flex-shrink-0 overflow-hidden rounded-lg">
                        <img
                          src={item.image}
                          alt={item.name}
                      ...
                      <div className="flex-1">
                        ...
                        {item.shade && (
                          <p className="text-xs text-gray-500 mt-1">{item.shade}</p>
                        )}
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <div className="flex items-center space-x-3">
                            <button
                              ...
                              className="w-8 h-8 flex items-center justify-center border border-gray-300 hover:border-gray-400 transition-colors rounded"
                            >
            ...
            <div className="border-t border-gray-200 p-6 space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-light">Nous consulter</span>
                </div>
                <div className="flex justify-between text-lg pt-4 border-t border-gray-200">
                  <span className="font-light">Total</span>
                  <span className="font-light">{total.toLocaleString()} FCFA</span>
                </div>
              </div>
              
              <button
                onClick={handleCheckout}
                className="w-full bg-black text-white py-4 hover:bg-gray-900 transition-all duration-300 rounded"
              >
              ...
              <button
                onClick={handleClose}
                className="w-full border border-gray-300 text-gray-700 py-4 hover:border-gray-400 hover:bg-gray-50 transition-all duration-300 rounded"
              >
